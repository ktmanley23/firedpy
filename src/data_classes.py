    ...
    def __init__(self, out_dir: str):
        ...
        if hasattr(self, '_username') and hasattr(self, '_password'):
            try:
                ...
                print(f"⚠️  EarthAccess setup failed, falling back to legacy access: {e}")        
        # Setup EarthAccess for modern data access
        self._earthaccess = None
        if hasattr(self, '_username') and hasattr(self, '_password'):
            try:
        ...
        if hasattr(self, '_earthaccess') and self._earthaccess is not None:
            try:
                ...
                if success:
                    ...
                    print(f"⚠️  EarthAccess download failed for {os.path.basename(dest)}, trying legacy method")
            except Exception as e:
                print(f"⚠️  EarthAccess error: {e}, falling back to legacy method")
        ...
        try:
            ...
            for tile in tiles:
                ...
                if not tile_granules:
                    print(f"   ⚠️  No data found for tile {tile}")
                    continue
...
class LandCover(Base):
    ...
    def _setup_earthaccess(self):
        ...
        try:
            ...
            print(f"⚠️  EarthAccess setup failed for land cover: {e}")
        ...
        try:
            ...
            for tile in requested_tiles:
                if tile in available_tiles:
                    ...
                    print(f"   ⚠️  {tile} - No mapping defined")
        ...
        try:
            ...
            for tile in available_tiles:
                ...
                for year in available_years:
                    ...
                    if not tile_granules:
                        print(f"   ⚠️  No land cover data for {tile} in year {year}")
                        continue
            ...
            print("⚠️  Continuing without land cover data...")
